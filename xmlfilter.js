...
const getGitHubProject = xmlNode =>{ 
    return { 
        app: contentOfSource(xmlNode).replace('https://github.com/', ''),
        dataAdicionado: contentOfAdded(xmlNode),
        dataUltimaAtualizacao: contentOfUpdated(xmlNode)
    }
}
...
const dto = (xmlNode) => {
    return{
        app: contentOfSource(xmlNode).replace('https://github.com/', ''),
        dataAdd: contentOfAdded(xmlNode),
        dataAtualizacao: contentOfUpdated(xmlNode)
    }
}
